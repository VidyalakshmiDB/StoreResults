    ...
    <?php include 'header_cse.php' ?>
        ...
        <div class="row " style="padding-left:40px;padding-right:40px;">
            ...
            <?php
                 ...
                 echo "<tr>";
                 echo "<td>". "18CS61". "</td>";
                 echo "<td>". "SYSTEM SOFTWARE AND COMPILER DESIGN". "</td>";
             ...
             echo "<tr>";
                 echo "<td>". "18CS62". "</td>";
                 echo "<td>". "COMPUTER GRAPHICS AND VISUALISATION". "</td>";
             ...
             echo "</tr>";
             echo "<tr>";
                 echo "<td>". "18CS644 / 18CS641". "</td>";
                 echo "<td>". "PROFESSIONAL ELECTIVE - 1 / DATA MINING AND DATA WARE HOUSING". "</td>";
                 echo "<td>" . $row['sub64_in'] . "</td>";
                 echo "<td>" . $row['sub64_ex'] . "</td>";
                 echo "<td>" . $row['sub64_total'] . "</td>";
             echo "</tr>";
             echo "<tr>";
                 echo "<td>". "18ME653 / 18CV651". "</td>";
                 echo "<td>". "SUPPLY CHAIN MANAGEMENT / REMOTE SENSING AND GIS". "</td>";
             ...
             echo "<tr>";
                 echo "<td>". "18CSL66". "</td>";
                 echo "<td>". "SYSTEM SOFTWARE LABORATORY". "</td>";
            ...
            echo "<tr>";
                 echo "<td>". "18CSL67". "</td>";
                 echo "<td>". "COMPUTER GRAPHICS LABORATORY WITH MINI PTOJECT". "</td>";
            ...
            echo "<tr>";
                 echo "<td>". "18CSMP68". "</td>";
                 echo "<td>". "MOBILE APPLICATION DEVELOPMENT LAB (MINI PROJECT)". "</td>";
    ...
    <?php include 'footer.php' ?>
        <script>
            function createPDF() {
                ...
                win.document.write('<title>6th semester</title>');
