<?php
    ...
    $sub39_in = $_POST['sub39_in'];
    $sub39_ex = $_POST['sub39_ex'];
    $sub39_total = $_POST['sub39_total'];
    ...
    $sql2 = "SELECT `sem2_sgpa` FROM `result_cse_sem2` WHERE `u_usn` = '$u_usn'";
    ...
    try{
        ...
        echo $sql = "INSERT INTO `result_cse_sem3` 
            ...
            $stmt->execute();
            $lastRow = $dbo1->lastInsertId('$result_cse_sem3'); 
            $dbo1->commit();
