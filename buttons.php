<div class="modal fade" id="examplesemone" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content text-dark">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks.php">
...
<div class="modal fade" id="examplesemtwo" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_two.php">
                        <table class="table">
                            <tr>
                                <td><h6>18MAT21</h6> </td>
...
<div class="modal fade" id="examplesemthree" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_three.php">
                        <table class="table">
                        <tr> 
                            <th> Code </th>
                            <th> Subject name </th>
...
<div class="modal fade" id="examplesemfour" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_four.php">
                    <table class="table">
                        <tr> 
                            <th> Code </th>
                            <th> Subject name </th>
...
<div class="modal fade" id="examplesemfive" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_five.php">
                    <table class="table">
                        <tr> 
                            <th> Code </th>
                            <th> Subject name </th>
...
<div class="modal fade" id="examplesemsix" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_six.php">
                    <table class="table">
                        <tr> 
                            <th> Code </th>
                            <th> Subject name </th>
                        ...
                        <tr>
                            <td><h6>18CS61</h6> </td>
                            <td class="cell-breakWord"><h6> SYSTEM SOFTWARE AND COMPILER DESIGN </h6>	 </td>
                        ...
                        <tr>
                            <td><h6>18CS62</h6> </td>
                            <td class="cell-breakWord"> <h6>COMPUTER GRAPHICS AND VISUALISATION </h6> </td>
                        ...
                        <tr>
                            <td><h6>18CS644 / 18CS641</h6> </td>
                            <td class="cell-breakWord"><h6>PROFESSIONAL ELECTIVE - 1 / DATA MINING AND DATA WARE HOUSING</h6> </td>
                        ...
                        <tr>
                            <td><h6>18ME653 /  18CV651 </h6></td>
                            <td class="cell-breakWord"><h6> SUPPLY CHAIN MANAGEMENT /  REMOTE SENSING AND GIS</h6> </td>
                        ...
                        <tr>
                            <td><h6>18CSL66 </h6></td>
                            <td class="cell-breakWord"> <h6> SYSTEM SOFTWARE LABORATORY </h6> </td>
                        ...
                        <tr>
                            <td><h6>18CSL67 </h6></td>
                            <td class="cell-breakWord"> <h6>   COMPUTER GRAPHICS LABORATORY WITH MINI PTOJECT  </h6></td>
                        ...
                        <tr>
                            <td> <h6>18CSMP68 </h6> </td>
                            <td class="cell-breakWord"> <h6> MOBILE APPLICATION DEVELOPMENT LAB (MINI PROJECT) </h6></td>
...
<div class="modal fade" id="examplesemseven" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_seven.php">
                    <table class="table">
                        <tr> 
                            <th><h4>Code </h4></th>
                            <th><h4>Subject name </h4></th>
...
<div class="modal fade" id="examplesemeight" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered col-sm-10" role="document">
        <div class="modal-content text-dark">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
                <div class="login px-4 mx-auto mw-100">
                    ...
                    <form autocomplete="off" name="user_login" method="POST"  action="insert_marks_eight.php">
                    <table class="table">
                        <tr> 
                            <th> Code </th>
                            <th> Subject name </th>
