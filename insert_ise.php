<?php
    ...
    try{
        ...
        echo $sql = "INSERT INTO `result_ise_sem1` (`u_usn`, `sub11_in`, `sub11_ex`, `sub11_total`, `sub12_in`, `sub12_ex`, `sub12_total`, `sub13_in`, `sub13_ex`, `sub13_total`, `sub14_in`, `sub14_ex`, `sub14_total`, `sub15_in`, `sub15_ex`, `sub15_total`, `sub16_in`, `sub16_ex`, `sub16_total`, `sub17_in`, `sub17_ex`, `sub17_total`, `sub18_in`, `sub18_ex`, `sub18_total`, `sem1_total`, `sem1_sgpa`) 
        ...
        $stmt->execute();
        $lastRow = $dbo1->lastInsertId('$result_ise_sem1'); 
        $dbo1->commit();
