<?php
    ...
    $sub86_in = $_POST['sub86_in'];
    $sub86_ex = $_POST['sub86_ex'];
    $sub86_total = $_POST['sub86_total']; 
    
    $sem8_total = $sub81_total + $sub82_total + $sub83_total + $sub84_total + $sub85_total + $sub86_total;
    ...
    if($sub86_total >= 90 && $sub86_total <= 100)
            $credit6 = 10;
        else if($sub86_total >= 80 && $sub86_total < 90) 
                $credit6 = 9;
            else if($sub86_totall >=70 && $sub86_total <80)
                $credit6 = 8;
                else if($sub86_total > 60 &&$sub86_total <= 70 )
                        $credit6 = 7;
                    else if($sub86_total > 45 && $sub86_total <= 60)
                        $credit6 = 6;
                        else if($sub86_total > 40 &&$sub86_total <= 45)
                            $credit6 = 4;
                            else 
                                $credit6 = 0;

        $sem8_sgpa = (($credit1 * 3) + ($credit2 * 3) + ($credit3 * 3) + ($credit4 * 3) + ($credit5 * 3) + ($credit6 * 1)) / 16;
        ...
        $sql7 = "SELECT `sem7_sgpa` FROM `result_cse_sem7` WHERE `u_usn` = '$u_usn'";
        ...
        try{
            ...
            echo $sql = "INSERT INTO `result_cse_sem8` 
            ...
            $stmt->execute();
            $lastRow = $dbo1->lastInsertId('$result_cse_sem8'); 
            $dbo1->commit();
